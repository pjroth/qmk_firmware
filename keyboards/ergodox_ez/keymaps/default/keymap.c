 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSp   | A/L1 |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L1|   '    |
 * |--------+------+------+------+------+------| L2   |           | Meh  |------+------+------+------+------+--------|
 * | Shft ( |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| Shft ) |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|CtlShf|AltShf| Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L1    |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Alt  | LGui |       | LGui | Alt  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_BSPC,        LT(SYMB,KC_A),         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSPO,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   TG(MDIA),
        LT(SYMB,KC_GRV),LCTL(KC_LSFT),LALT(KC_LSFT),  KC_LEFT,KC_RGHT,
                                              KC_LALT,  KC_LGUI,
                                                              KC_HOME,
